...
@onready var health_control: Control = $HealthControl
...
@onready var mana_control: Control = $ManaControl
...
@onready var energy_control: Control = $EnergyControl
...
@onready var exp_control: Control = $ExpControl
@onready var exp_bar: TextureProgressBar = $ExpControl/TextureProgressBar
