...
@onready var progress_bar: ProgressBar = $VBoxContainer/Healthbar/ProgressBar
@onready var progress_bar_bg: ProgressBar = $VBoxContainer/Healthbar/ProgressBarBG
...
func _ready() -> void:
	...
	progress_bar.max_value = enemy_stats.health_points
	progress_bar.value = enemy_stats.current_health_points
	progress_bar_bg.max_value = enemy_stats.health_points
	progress_bar_bg.value = enemy_stats.current_health_points
	...
	#enemy_stats.show_exp_on_dead.connect(_show_exp)
...
func setup_labels() -> void:
	var mob_level = enemy_stats.entity_level
	...
	enemy_name.text = enemy_stats.entity_name
