...
@onready var npc_portrait: TextureRect = $MarginContainer/MainContainer/DialogContainer/NPCPortrait

@onready var dialog_container: HBoxContainer = $MarginContainer/MainContainer/DialogContainer
@onready var dialog_text: Label = $MarginContainer/MainContainer/DialogContainer/DialogPanel/MarginContainer/DialogText

@onready var options_list: VBoxContainer = $MarginContainer/MainContainer/OptionsList
@onready var main_container: VBoxContainer = $MarginContainer/MainContainer
@onready var npc_name_label: Label = $MarginContainer/MainContainer/Header/NPCNameLabel
@onready var back_button: Button = $MarginContainer/MainContainer/Header/BackButton
