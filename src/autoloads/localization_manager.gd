...
func get_gem_quality(quality: GemItem.Quality) -> String:
	return get_translation("items.gem_quelity." + GemItem.GEM_QUALITY_KEY[quality])
	
func get_item_description(attribute: String) -> String:
	return get_translation("items.descriptions." + attribute)

func get_ui_attribute_name(attribute: String) -> String:
	return get_translation("ui.attributes." + attribute)
